...
const TCModal = ({ isOpen, onClose, onAgree }: TCModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg p-10 w-[70%] h-[80%] overflow-y-auto relative">
        <button
          onClick={onClose}
        ...
        >
          ...
          <section style={{ marginBottom: "20px" }}>
            ...
            >
              <li style={{ marginBottom: "10px" }}>
                Participation is directly linked to high-level conversations to
                be held at COP 29, such as ongoing negotiations.
              </li>
              <li style={{ marginBottom: "10px" }}>
              ...
              <li style={{ marginBottom: "10px" }}>
                Participation in thematic meetings as a representative of
                Nigeria.
              </li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: "20px" }}>
            ...
            >
              <li style={{ marginBottom: "10px" }}>
                Approvals will be granted strictly on merit, and
                full-and-real-time access into the data concerning who is
                attending and those the government is sponsoring to COP 29 will
                also be made available to the general public on the Climate
                Accountability and Transparency Portal (CAT-P) to ensure
                transparency.
              </li>
              <li style={{ marginBottom: "10px" }}>
                The Nigeria delegation is to efficiently utilize the on-site
                delegation office within the conference complex to host
                high-level meetings and bilaterals. Members of the delegation
                will therefore be required to schedule meetings ahead with the
          ...
          <section style={{ marginBottom: "20px" }}>
            ...
            >
              <li style={{ marginBottom: "10px" }}>
                ...
                participation is aligned with the theme for Nigeria,
                "Actualizing Financial Commitments for Climate Action," and the
                objective of their participation has an economic imperative and
                is directed toward engaging with companies, multilateral
                partners, and stakeholders who will attract finance and
                opportunities to Nigeria.
              </li>
              <li style={{ marginBottom: "10px" }}>
                <strong>Organizational Representation:</strong> Registration
                must be completed through a recognized organization; individual
                applications are not permitted.
              </li>
              <li style={{ marginBottom: "10px" }}>
                <strong>Mandate Alignment:</strong> The organization must have a
                clear mandate or mission aligned with climate change,
                sustainable development, or related issues, in line with
                national climate policies, the UNFCCC's goals, and the specific
                objectives of COP29.
              </li>
              <li style={{ marginBottom: "10px" }}>
              ...
              <li style={{ marginBottom: "10px" }}>
                ...
                organizations are responsible for covering all expenses related
                to their representatives’ participation in the UNFCCC COP29.
              </li>
              <li style={{ marginBottom: "10px" }}>
                <strong>Mandatory Reporting:</strong> By registering to
                participate in COP29, organizations commit to submitting a
                comprehensive report detailing sessions, events, and outcomes of
                their participation, which will form part of the final COP29
                national report.
              </li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: "20px" }}>
            ...
            >
              <li style={{ marginBottom: "10px" }}>
                ...
                sustainable development. Non-governmental bodies should apply
                via the side event application process.
              </li>
              <li style={{ marginBottom: "10px" }}>
                <strong>Application Submission:</strong> Complete your
                application through your organization, not as an individual.
              </li>
              <li style={{ marginBottom: "10px" }}>
            ...
            prepare to cover the associated fees.
              ...
              <li style={{ marginBottom: "10px" }}>
                ...
                participants attend the orientation and pre-COP29 workshop
                organized by the NCCC.
              </li>
              <li style={{ marginBottom: "10px" }}>
                <strong>Post-COP Report:</strong> After COP29, a comprehensive
                report detailing sessions, events, and outcomes, endorsed by the
                organization's Head, must be submitted to the National Council
                on Climate Change.
              </li>
            </ul>
          </section>
