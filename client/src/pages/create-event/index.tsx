...
const CreateEvent = () => {
  ...
  return (
    <>
      {isLoading || slotLoading || (userLoading && <Loader />)}
      {user && user.data.userType === "organization" ? (
        <div className="flex items-center justify-center p-4 md:p-20 w-full h-auto p-10 bg-green-800">
          <div
