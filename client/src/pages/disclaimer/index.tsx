const TermsAndConditions = () => {
  return (
    ...
    >
      ...
      >
        {/* THE DEADLINE FOR COP29 REGISTRATION  CLOSES ON 25th October 2024. */}
        REGISTRATION FOR COP29 ON THE PORTAL WILL CLOSE ON 25th OCTOBER 2024.
      </p>
      ...
      <section style={{ marginBottom: "20px" }}>
        ...
        <ul style={{ lineHeight: "1.6" }}>
          <li>
            ...
            bodies may qualify and be considered if they apply for a side event
            slot.
          </li>
          <li>
          ...
          <li>
            <strong>Limited Delegation:</strong>{" "}
            <span className="text-red-500">
              In compliance with Federal Government directives, organizations
              may submit a maximum of two participants for accreditation. Up to
              two additional participants may be considered for organizations
              hosting side events.
            </span>
          </li>
          <li>
      ...
      <section style={{ marginBottom: "20px" }}>
        ...
        <ul style={{ lineHeight: "1.6" }}>
          ...
          <li>
            ...
            Climate Change Secretariat at{" "}
            <a href="mailto:info@natcccc.gov.ng">info@natcccc.gov.ng</a>.
          </li>
        </ul>
      </section>
    </div>
